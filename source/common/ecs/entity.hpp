...
namespace our
{
    ...
    public:
        ...
        T *addComponent()
        {
            ...
            //  first we create a new component of type T which is generic
            T *component = new T();
            // then we set the owner of the component to be this entity
            component->owner = this;
            // then we push the component into the components list
            components.push_back(component);
            // then we return a pointer to the new component
            return component;
        }
        ...
        T *getComponent()
        {
            ...
            //  we will loop through the components list and find the first component that can be dynamically cast to "T*" and return it
        ...
        void deleteComponent()
        {
            ...
            //  we will loop through the components list and find the first component that can be dynamically cast to "T*" and delete it
            for (auto it = components.begin(); it != components.end(); it++)
            {
                T *component = dynamic_cast<T *>(*it);
                if (component != nullptr)
        ...
        void deleteComponent(T const *component)
        {
            ...
            //  If found, delete the found component and remove it from the components list
            //  we will loop through the components list and find the given component "component" and delete it
            for (auto it = components.begin(); it != components.end(); it++)
            {
                if (*it == component)
                {
        ...
        ~Entity()
        {
            ...
            //  we will loop through the components list and delete all the components
            for (auto it = components.begin(); it != components.end(); it++)
            {
                delete *it;
            }
