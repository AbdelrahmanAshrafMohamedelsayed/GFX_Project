...
namespace our
{
    ...
    public:
        ...
        void markForRemoval(Entity *entity)
        {
            ...
            //  if the entity is in this world (entities container), add it to the "markedForRemoval" set
        ...
        void deleteMarkedEntities()
        {
            ...
            //  we will loop over the markedForRemoval set and delete the entities in it
        ...
        void clear()
        {
            ...
            // clear the entities and markedForRemoval sets
            entities.clear();
            markedForRemoval.clear();
        }
